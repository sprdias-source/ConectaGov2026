              ...
              <tbody>
                {yearly.map((m) => (
                  ...
                  >
                    ...
                    <td className="py-2 pr-3 text-right font-mono text-negative-400">{m.saidas > 0 ? formatBRL(m.saidas) : '—'}</td>
          ...
          <div className="flex flex-wrap items-center justify-between gap-3 mb-4">
            ...
            <div className="flex gap-2">
              ...
              <div className="bg-base-850 border border-base-700 rounded-lg px-3 py-1.5 text-center">
                ...
                <p className="text-negative-400 font-mono font-bold text-sm">{formatBRL(totalSaidas)}</p>
              </div>
                ...
                <div className="flex flex-col gap-1.5">
                  {liquidados.map((t) => (
                    <div key={t.id} className="flex items-center justify-between gap-2 bg-base-850/60 rounded-lg px-3 py-2">
                      ...
                      <span className={`font-mono font-bold text-[12px] shrink-0 ${t.type === 'Receber' ? 'text-positive-400' : 'text-negative-400'}`}>
            ...
            <div>
              ...
              <div className="border-t border-base-800 mt-3 pt-3 flex flex-col gap-1.5 text-[12px]">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-mono font-bold text-negative-400">{formatBRL(aPagarAgendado)}</span>
                </div>
