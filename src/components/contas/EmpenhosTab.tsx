...
import { Plus, Pencil, Trash2, FileSpreadsheet, Ban, CheckCircle2, Repeat, RepeatIcon } from 'lucide-react'
...
export default function EmpenhosTab() {
  const { empenhos, isLoading, addEmpenho, updateEmpenho, updateEmpenhoStatus, stopRecurrence, deleteEmpenho } = useEmpenhos()
