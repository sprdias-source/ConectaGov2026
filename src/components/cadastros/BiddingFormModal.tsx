...
export default function BiddingFormModal({
  open, onClose, onSave, initial, clients, isSaving, clientIsMensalista,
}: {
  open: boolean
  onClose: () => void
          ...
          <>
            ...
            {isNaoMensalista && (
              <div className="bg-accent-500/10 border border-accent-500/25 rounded-lg p-3">
                <Field label="Taxa de Participação Individual (R$) — cliente não-mensalista">
                ...
                <p className="text-[11px] text-base-400 mt-1.5">
                  Ao salvar, esse valor poderá ser lançado em Transações como "a receber" independente do resultado da disputa.
                </p>
              </div>
            )}
