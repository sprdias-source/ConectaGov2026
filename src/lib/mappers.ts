...
export const fromClientRow = (r: Row<'clients'>): Client => ({
  ...
  responsavelEndereco: r.responsavel_endereco,
...
export const toClientInsert = (c: Partial<Client>, userId: string): Database['public']['Tables']['clients']['Insert'] => ({
  ...
  responsavel_endereco: c.responsavelEndereco ?? null,
...
export const fromBiddingRow = (r: Row<'biddings'>): Bidding => ({
  ...
  propostaBancoNome: r.proposta_banco_nome,
  propostaBancoAgencia: r.proposta_banco_agencia,
  propostaBancoConta: r.proposta_banco_conta,
...
export const toBiddingInsert = (b: Partial<Bidding>, userId: string): Database['public']['Tables']['biddings']['Insert'] => ({
  ...
  proposta_banco_nome: b.propostaBancoNome ?? null,
  proposta_banco_agencia: b.propostaBancoAgencia ?? null,
  proposta_banco_conta: b.propostaBancoConta ?? null,
...
export const fromTransactionRow = (r: Row<'transactions'>): Transaction => ({
  ...
  dataVencimentoPrefeitura: r.data_vencimento_prefeitura,
  dataLiquidacaoPrefeitura: r.data_liquidacao_prefeitura,
...
export const toTransactionInsert = (t: Partial<Transaction>, userId: string): Database['public']['Tables']['transactions']['Insert'] => ({
  ...
  data_vencimento_prefeitura: t.dataVencimentoPrefeitura ?? null,
  data_liquidacao_prefeitura: t.dataLiquidacaoPrefeitura ?? null,
...
export const fromContractRow = (r: Row<'contracts'>): Contract => ({
  ...
  clientId: r.client_id,
  biddingId: r.bidding_id,
  tipo: (r.tipo as Contract['tipo']) ?? 'mensalista',
  ...
  vigenciaMeses: r.vigencia_meses,
  status: (r.status as Contract['status']) ?? 'ativo',
  createdAt: r.created_at,
  updatedAt: r.updated_at,
})
...
export const fromEmpresaPerfilRow = (r: Row<'empresa_perfil'>): EmpresaPerfil => ({
  ...
  representanteNome: r.representante_nome,
  representanteCpf: r.representante_cpf,
  representanteEstadoCivil: r.representante_estado_civil,
  representanteEndereco: r.representante_endereco,
  bancoNome: r.banco_nome,
  bancoAgencia: r.banco_agencia,
  bancoConta: r.banco_conta,
  chavePix: r.chave_pix,
  comarcaForoPadrao: r.comarca_foro_padrao,
  createdAt: r.created_at,
  updatedAt: r.updated_at,
})
